...
@Component({
  selector: 'app-corporate-question-template',
  templateUrl: './corporate-question-template.component.html',
  styleUrls: ['./corporate-question-template.component.css']
})
export class CorporateQuestionTemplateComponent implements OnInit {
