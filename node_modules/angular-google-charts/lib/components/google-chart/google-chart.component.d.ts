...
export declare class GoogleChartComponent implements ChartBase, OnChanges, OnInit {
    ...
    private drawChart;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<GoogleChartComponent, [null, null, { optional: true; }]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<GoogleChartComponent, "google-chart", ["googleChart"], { "options": "options"; "dynamicResize": "dynamicResize"; "type": "type"; "data": "data"; "columns": "columns"; "title": "title"; "width": "width"; "height": "height"; "formatters": "formatters"; }, { "ready": "ready"; "error": "error"; "select": "select"; "mouseover": "mouseover"; "mouseleave": "mouseleave"; }, never, never, false, never>;
}
