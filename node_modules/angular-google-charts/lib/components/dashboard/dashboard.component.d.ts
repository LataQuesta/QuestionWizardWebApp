...
export declare class DashboardComponent implements OnInit, OnChanges {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<DashboardComponent, "dashboard", ["dashboard"], { "data": "data"; "columns": "columns"; }, { "ready": "ready"; "error": "error"; }, ["controlWrappers"], ["*"], false, never>;
}
